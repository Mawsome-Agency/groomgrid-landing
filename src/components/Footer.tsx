        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://twitter.com/groomgrid"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="GroomGrid on Twitter"
              ...
              <a
                href="https://instagram.com/groomgrid"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="GroomGrid on Instagram"
                className="w-9 h-9 bg-gray-800 hover:bg-gray-700 rounded-lg flex items-center justify-center transition-colors"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://facebook.com/groomgrid"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="GroomGrid on Facebook"
                className="w-9 h-9 bg-gray-800 hover:bg-gray-700 rounded-lg flex items-center justify-center transition-colors"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
