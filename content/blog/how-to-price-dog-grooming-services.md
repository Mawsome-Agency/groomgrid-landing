---
title: "How to Price Dog Grooming Services: The Groomer's Profitability Formula"
description: "Stop guessing your grooming prices. This step-by-step formula builds your rates from actual costs up — so every groom covers expenses and pays you properly."
date: "2026-03-07"
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "How to Price Dog Grooming Services: The Groomer's Profitability Formula",
  "description": "Stop guessing your grooming prices. This step-by-step formula builds your rates from actual costs up — so every groom covers expenses and pays you properly.",
  "url": "https://getgroomgrid.com/grooming-pricing/how-to-price-dog-grooming-services/",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://getgroomgrid.com/grooming-pricing/how-to-price-dog-grooming-services/"
  }
}
</script>
...
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "HowTo",
  "name": "How to Price Dog Grooming Services",
  "description": "A 4-step profitability formula for setting grooming prices based on real costs, time per breed, and local market positioning.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Calculate Your Hourly Cost",
      "text": "Add up all monthly fixed and variable business expenses, divide by your working hours per month to get your true break-even hourly rate."
    },
    {
      "@type": "HowToStep",
      "name": "Calculate Your Groom Time by Breed and Coat Type",
      "text": "Build a time matrix for each service type by breed category. Know exactly how long each groom takes before setting prices."
    },
    {
      "@type": "HowToStep",
      "name": "Set Your Price Floor",
      "text": "Multiply hourly cost by groom time, add supply costs, then apply a 30–40% profit margin. This is your minimum — never price below it."
    },
    {
      "@type": "HowToStep",
      "name": "Research Local Market Rates Without Copying Them",
      "text": "Check local competitors to understand market positioning, then adjust above your price floor based on your service quality and differentiation."
    }
  ]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How do groomers set their prices?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The most reliable method is cost-based pricing: calculate your true hourly cost (all expenses divided by working hours), determine how long each groom type takes, then set prices that cover costs plus a 30–40% profit margin. Checking local market rates helps you position competitively without pricing yourself out."
      }
    },
    {
      "@type": "Question",
      "name": "Is it okay to raise dog grooming prices?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, and most established groomers don't do it often enough. Best practice: raise for new clients first, give 30 days notice to existing clients, and frame increases as reflecting rising supply and operating costs. Loyal clients almost always absorb a 10–15% increase."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Mobile groomers typically charge $15–$35 more than equivalent salon services to cover fuel, drive time, and the overhead of a self-contained mobile unit. An additional fuel surcharge of $10–$20 is common for clients outside the primary service zone."
      }
    },
    {
      "@type": "Question",
      "name": "What is the average dog grooming price per hour?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Effective hourly rates for groomers vary widely by market, but most established groomers aim for $50–$90 per service hour after all costs. The important figure is your own hourly cost — what you need to earn per hour just to break even — which you calculate from your actual expenses."
      }
    }
  ]
}
...
**Monthly Fixed Costs:**
- Van loan payment or salon rent
- General liability insurance
- Commercial auto insurance (mobile)
- Grooming software subscription
...
| Grooming software | $49 |
| Phone (business portion) | $50 |
| Marketing | $75 |
| Supplies | $250 |
| Fuel | $300 |
...
| Breed/Coat Type | Bath Only | Bath + Trim | Full Groom |
|----------------|-----------|-------------|------------|
| Small smooth coat (Chihuahua, Dachshund, Beagle) | 25–30 min | 40–45 min | 55–60 min |
| Small long coat (Shih Tzu, Maltese, Yorkshire Terrier) | 40–45 min | 55–65 min | 75–90 min |
| Medium curly coat (Cockapoo, Cavapoo, small Goldendoodle) | 55–65 min | 70–80 min | 90–120 min |
| Large curly/doodle coat (standard Goldendoodle, Bernedoodle, Labradoodle) | 70–80 min | 85–100 min | 120–150 min |
| Double coat large (Husky, Golden Retriever, Shepherd, Malamute) | 70–80 min | N/A | 90–120 min |
| Working coat medium (Spaniel, Setter) | 50–60 min | 65–75 min | 80–90 min |
...
Once you know your time per groom type, you can set breed-specific prices that actually reflect the work involved — not a flat rate that undersells your most labor-intensive appointments. See [dog grooming prices by breed](/blog/dog-grooming-prices-by-breed) for market rate references by breed category.
...
- Hourly cost: $10.62
- Groom time: 2 hours
- Supply cost per groom (shampoo, conditioner, disposable collar, etc.): $8
- Base cost: ($10.62 × 2) + $8 = **$29.24**
- Add 35% profit margin: $29.24 × 1.35 = **$39.47**
- Round to: **$40 minimum**
...
- Fuel cost per appointment (variable by distance)
- Drive time (which is dead time — you're not grooming while driving)
- Self-contained van overhead: water system, power, generator/shore power setup
- Higher equipment wear from mobile operation
...
For a complete pricing reference table for mobile services by breed and size, see [mobile dog grooming price list](/blog/mobile-dog-grooming-price-list).
...
| Add-On Service | Suggested Price Range |
|---------------|----------------------|
| Nail trim (with groom) | $5–$10 |
| Nail grinding (Dremel) | $10–$20 |
| Teeth brushing | $10–$15 |
| Ear cleaning | $8–$15 |
| De-shed treatment (blow-out + de-shed shampoo) | $20–$50 |
| Blueberry facial | $10–$20 |
| Flea/tick treatment shampoo | $15–$30 |
| Bandana or bow | $3–$5 |
| Cologne/perfume finish | $5–$8 |
...
For a broader look at how software handles pricing alongside [payment and pricing management tools](/blog/pet-grooming-appointment-no-shows), protecting your revenue starts with being clear about what things cost — before the appointment, not at the end of it.
...
One pricing conversation that groomers often get asked about: tipping. Clients frequently want to know whether it's expected — [here's what groomers typically receive and what's considered standard](/blog/do-you-tip-dog-groomers).
